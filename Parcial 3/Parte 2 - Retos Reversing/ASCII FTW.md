...
hani06@DESKTOP-4NE4RTQ:/mnt/c/Users/Hani/Documents/picoCTF/ascii$ cat flag.txt | cut -d "," -f2 | xxd -r -p
picoCTF{ASCII_IS_EASY_7BCD971D}

## Notas
Con la ayuda de ghidra, es posible encontrar el código que genera la bandera 
